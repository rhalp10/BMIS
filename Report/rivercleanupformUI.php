...
<body>
    ...
    <form action="rivercleanupform.php" method="POST">
        <center>
            <p>
            <h4>REPUBLIC OF THE PHILIPPINES <br> Province of Cavite <br> Municipality of Indang <br> <label> BARANGAY
                </label> <input type="text" name="barangay" value=<?php echo $brgy;?>> </h4>
            </p>

            <p>


            <h3>RIVER CLEAN-UP DATA CAPTURE FORM</h3>
        </center>
