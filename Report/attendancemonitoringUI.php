...
<body>
    ...
    <header id="emengheader">
        <h1 align='left' id="emengheader"> <a href="viewreport.php"><button class='btn btn-success'> back </button></a>
        </h1>
    </header>

    <button id="buttonmoto" style="display:none;" class="btn btn-danger btn-lg danger" role="button"
        onclick="exitna()">Cancel</button>
            ...
            <table class="table table-bordered" id="attendance_table">
                ...
                <div class="whole">
                    ...
                    <center>
                        ...
                        <center>
                            <font face="Gordana" size="4"> PERSONNEL ATTENDANCE MONITORING <br>
                                ...
                                <tr>
                                    ...
                                    <br>
                                    <th>
                                        <center>LGU (Province, City,Municipality, Barangay (1)</center>
                                    </th>
                                    <th>
                                        <center>Name of Non-Compliant Personnel(2)</center>
                                    </th>

                                    <th colspan="2">
                                        <center>Nature of Non-Compliance(3)</center>
                                    </th>
                                    <th>
                                        <center>Station</center>
                                    </th>
                                    <th>
                                        <center>Position/Designation</center>
                                    </th>
                            </font>
                            ...
                            <tr>
                                ...
                                <th> </th>
                                <th>
                                    <center>Habitual Absenteeism </center>
                                </th>
                                <th>
                                    <center>Habitual Tardiness</center>
                                </th>
                                <th> </th>
                                <th> </th>
	...
	$select = mysqli_query($dbsabmis, $sqlngbmis); 
...
?>
                            ...
                            <tr bgcolor=white>
                                ...
                                <td><input type="texttable" id="barangaychairman1" readonly placeholder=""
                                        value="<?php echo $_SESSION['barangay'];?>"></td>
            ...
            <center>
                ...
                <input class="form-control113" id="exampleInputName2" type="text"
                    value="<?php echo $_SESSION['secretary']?>" readonly> <br>
                <label1 for="exampleInputName2">Kalihim</label1> <br><br>



                <b>
                    <label1 for="exampleInputName2">Submitted By:</label1><br>
                </b>
                <input class="form-control113" id="exampleInputName2" type="text"
                    value="<?php echo $_SESSION['captain']?>" readonly> <br>
                <label1 for="exampleInputName2">Punong Barangay</label1> <br><br>



                <b>
                    <label1 for="exampleInputName2">Noted By:</label1><br>
                </b>
            ...
            <center>
                ...
                <p class="text-center">
                    <button class="btn btn-primary btn-lg active" role="button" onclick="savemona()">Save</button>
                </p>
        </form>
