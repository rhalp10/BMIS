    ...
    <center>
        <form target="_blank" method="post" action="avawcform.php">
            ...
            <div class="whole">
                ...
                <center>
                    <font face="Gordana" size="4"> CONSOLIDATED QUARTERLY COMPLIANCE MONITORING REPORT RE: RA 9262
                        (AVAWC) <br>
                ...
                <br>
                <p class="text-left">
                    <font face="Gordana" size="4"> Municipality: INDANG</font>
                </p><br>
                ...
                <center>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>
                                    <center>BARANGAY <br>(1)</center>
                                </th>
                                <th>
                                    <center>TOTAL<br>NO.OF<br>VAWC<br>CASES<br>(2)</center>
                                </th>
                                <th colspan="4 ">
                                    <center>NO.OF VAW CASES REPORTED<br>(3)</center>
                                </th>
                                <th>
                                    <center> TOTAL<br> (4)</cente>
                                </th>
                                <th colspan="4">
                                    <center>NO.OF CASES ACTED UPON<br>(5)</center>
                                </th>
                                <th>
                                    <center> TOTAL NO. <br> OF VAWC<br> CASES<br> ACTED<br>UPON<br>(6)</center>
                                </th>
                                <th colspan="2">
                                    <center>PROGRAMS/PROJ.<br> IMPLEMENTED<br> (7)</center>
                                </th>
                                <th>
                                    <center>FUNDS<br> ALLOCATED<br> (8)</center>
                                </th>
                            ...
                            <tr>
                                ...
                                <td> </td>
                                <th>
                                    <center>Physical <br>Abuse<br> (a)</center>
                                </th>
                                <th>
                                    <center>Sexual<br> Abuse<br>(b)</center>
                                </th>
                                <th>
                                    <center>Psychological <br>Abuse <br>(c) </center>
                                </th>
                                <th>
                                    <center> Economic <br>Abuse<br> (d)</center>
                                </th>
                                <td></td>

                                <th>
                                    <center>Referred <br> to LSWDO <br> (a)</center>
                                </th>
                                <th>
                                    <center>Referred <br> to PNP <br> (b)</center>
                                </th>
                                <th>
                                    <center>Referred <br> to Court <br> (c)</center>
                                </th>
                                <th>
                                    <center>Referred <br> to Medical <br> (d)</center>
                                </th>
                                <td></td>

                                <th>
                                    <center>Training<br> (a)</center>
                                </th>
                                <th>
                                    <center>IEC<br>(b)</center>
                                </th>
                ...
                <input class="form-control113" id="exampleInputName2" name="desk" type="text"
                    value="<?php echo $_SESSION['desk'];?>">
