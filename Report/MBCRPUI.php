...
$(document).ready(function(){
    $('#save').on('click',function(){
		...
		if(q==''||f==''||t==''||ca==''||ch==''||a==''||aa==''||ta==''||cch==''||cc==''||ccc==''||c==''){
		...
		if(aconfirm==true){
            $.ajax({
                type:'POST',
                url:'manilatodb.php',
                data:{q:q, f:f, t:t, ca:ca, ch:ch, a:a, aa:aa, ta:ta, cch:cch, cc:cc, ccc:ccc, c:c, k1:k1, k2:k2, k3:k3, k4:k4, l1:l1, l2:l2, l3:l3, l4:l4, r1:r1, r2:r2, r3:r3, r4:r4, n1:n1, n2:n2, n3:n3, n4:n4},
     ...
     <div class="col-sm-6" >
            <p> <b>3.1</b> Total number of households:
             ...
             <p><b>3.2</b> Total number of compliant households:
                     <input type="text" name="tnc" size="25" required></p>
      
             <p><b>3.3</b> Computed average*(Use Formula below
                     <input type="text" name="ca" required size="25"></p>
 ...
 <table class="table table-bordered"  >
    ...
    <th rowspan="1" style="color:white;text-align:left;">Is there an existing MRF servicing the Barangay, whether individual, cluster or municipal? (50%)</th>
        ...
        <tr>
          ...
          <th style="background-color:white" ><input type="text" required name="barangaychairman" size="25" ></th>
           </tr>
