...
$query = "SELECT * from users order by userlevel,username";	
...
<p><big><b>There are currently '.$num.' users.</b></big></p>


<table align="center" cellspacing="2" cellpadding="2" border="1">
	<tr><td align="center"><b>Username</b></td><td align="center"><b>User Level</b></td></tr> ';
	// Fetch and print all the records.
	while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
		$html2= $html2.'<tr><td align=\"left\">' . stripslashes($row[0]) . '</td><td align=\"left\">'.$row[2].'</td></tr>';
	}
...
//----------------USING A LOG-----------------
				...
				$content =  date('m/d/Y h:i:s a', time()) ." - ". $_COOKIE['userid']. " queried records of users in AY " . $_COOKIE['semyear']. "\r\n'users' - Records viewed\r\n";
