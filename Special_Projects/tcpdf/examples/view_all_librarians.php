...
$query = "SELECT * from librarian order by lib_lname";	
...
<p><big><b>There are currently '.$num.' personnels with access to the system.</b></big></p>


<table align="center" cellspacing="2" style="table-layout:fixed" cellpadding="2" border="1">
	<tr>
	<td align="center" width = "150"><b>Employee Number</b></td>
