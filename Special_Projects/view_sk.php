...
<form action = "view_tblprint1.php" method = "post"  target="_blank">
...
?>
  ...
  <th width="auto">TITLE</th>
    ...
    inner join (SELECT max(noe_setid) mxID FROM finance_fundoperation_noeset WHERE noe_id = 2) x ON f.noe_setid = x.mxID
