...
<a href="index.php">HOME</a>
  ...
  <div class="dropdown">
      ...
      <form action = "view_tblprint.php" method = "post">
...
while ($row = mysqli_fetch_assoc($result)) { ?> 
  ...
  $add=mysqli_query($con,'SELECT SUM(amount) from `annual_project` Where source="Barangay Development Fund" and year = (SELECT MAX(year) from annual_project);');
