...
<a href="index.php">HOME</a>
  ...
  <div class="dropdown">
    ...
    <form action = "view_tblprint3.php" method = "post">
<!-- <form class="filteroption" action="" method="post"> -->
      ...
      <section class="down">
        ...
        VIEW
          ...
          <div class="form">
            <h2 align="center">Details of Program / Project/ Activity by Sector of Barangay Council For The Protection of Children Fund</h2>
            ...
            <table width="100%" border="2">
                ...
                <tbody>
                    ...
                    <?php
$count=1;
$sel_query= "Select * from annual_project where `source`='Barangay Council For The Protection of Children Fund' and year = (SELECT MAX(year) from annual_project) ORDER BY project_id desc";
...
while ($row = mysqli_fetch_assoc($result)) { ?> 
  ...
  $add=mysqli_query($con,'SELECT SUM(amount) from `annual_project`   Where source="Barangay Council For The Protection of Children Fund" and year = (SELECT MAX(year) from annual_project);');
...
?>
  ...
  <th width="auto">TITLE</th>
    ...
    inner join (SELECT max(noe_setid) mxID FROM finance_fundoperation_noeset WHERE noe_id = 4) x ON f.noe_setid = x.mxID
