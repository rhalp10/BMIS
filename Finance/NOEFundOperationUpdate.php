...
<body>
    ...
    <br>
    <div class="head">
        <font size="5">Non-Office Expenditure Type Update</font>
    </div>
    <br><br>

    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button type="button" class="btn btn-primary col-lg-offset-0"
        onclick="location.href = 'NOEFundOperationView.php';">Back
        ...
        <article>
            ...
            <center>
                <form method="post" action="NOEFundOperationUpdateExec.php">
                    ...
                    <?php
				include('dbcon.php');
            $query1 = $db->query("SELECT * FROM finance_fundoperation_Noe WHERE Noe_id = '$id'");
			...
			?>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" value="<?php echo $row1["noe_code"]; ?>"
                                    required name="noe_code" size="50">
                        </tr>
                        <br>
