        ...
        <form action="CollectionInsertion.php" method="POST">
            ...
            <tr>
                ...
                <td><input type="text" class="form-control" size="50" id="col2" name="col2"
                        placeholder="Enter Collection Type" required></td>
                </div>

                <td>
                    <div class="form-group col-md-4">
                        <label for="col3">Amount</label>
                <td><input type="text" maxlength=20 class="form-control input-sm text-left amount" size="50" id="col3"
                        name="col3" placeholder="Enter Collection Amount" required></td>
                </div>
            </tr>
