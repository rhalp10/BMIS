...
<br><div class="head"><font size="5">Clearance Amount</font></div>
<br><br>
	...
	<tr>
		...
		<td><input type="text" maxlength=20 class="form-control input-sm text-right amount" name="price" placeholder="Enter Clearance Amount" required ></td>
	</div>
	</td>
	</tr>
