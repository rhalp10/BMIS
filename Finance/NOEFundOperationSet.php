...
<br>
	...
	<td>
		...
		<td><input type="text" maxlength=20 class="form-control input-sm text-right amount" name="noe_amount" placeholder="Enter NOE Amount" required ></td>
	</div>
	</tr>
...
<div class="form-group col-md-4">
	...
	<input class="form-control" type="text" readonly name="noe_year" value="<?php $d=date('Y'); echo $d+1; ?>">
