...
<body>
    ...
    <br>
    <div class="head">
        <font size="5">Maintenance Type Update</font>
    </div>
    <br><br>

    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button type="button" class="btn btn-primary col-lg-offset-0"
        onclick="location.href = 'MOOEFundOperationView.php';">Back
        ...
        <article>
            ...
            <center>
                <form method="post" action="MOOEFundOperationUpdateExec.php">
                    ...
                    <?php
				include('dbcon.php');
            $query1 = $db->query("SELECT * FROM finance_fundoperation_mooe WHERE mooe_id = '$id'");
			...
			?>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" value="<?php echo $row1["mooe_code"]; ?>"
                                    required name="mooe_code" size="50">
                        </tr>
                        <br>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" value="<?php echo $row1["mooe_type"]; ?>"
                                    required name="mooe_type" size="50">
                        </tr>
                        <br>
