...
<body>
    ...
    <button type="button" class="btn btn-primary col-lg-offset-0"
        onclick="location.href = 'ServiceFundOperationView.php';">Back
        ...
        <article>
            ...
            <center>
                <form method="post" action="ServiceFundOperationUpdateExec.php">
                    ...
                    <?php
				include('dbcon.php');
            $query1 = $db->query("SELECT * FROM finance_fundoperation_ps WHERE service_id = '$id'");
			...
			?>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control" value="<?php echo $row1["service_code"]; ?>"
                                    required name="service_code" size="50">
                        </tr>
                        <br>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" value="<?php echo $row1["service_type"]; ?>"
                                    required name="service_type" size="50">
                        </tr>
                        <br>
