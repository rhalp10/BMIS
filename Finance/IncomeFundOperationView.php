...
<br>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-primary col-lg-offset-0" onclick="location.href = 'IncomeFundOperation.php';"  >Back
...
<td><a href="IncomeFundOperationUpdate.php?id=<?php echo $row['income_id']?>" class="btn btn-primary">Update</a></td>
    <td><input type="button" onClick="deleteme(<?php echo $row['income_id']?>)" name="Delete" value="Delete" class="btn btn-primary"></td>
    </tr>  
