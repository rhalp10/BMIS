...
<br><br>
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="button" class="btn btn-primary col-lg-offset-0" onclick="location.href = 'ServiceFundOperationSet.php';"  >Back
...
<td><a href="ServiceFundOperationSetUpdate.php?id=<?php echo $row['service_setid']?>" class="btn btn-primary">Update</a></td>
    <td><input type="button" onClick="deleteme(<?php echo $row['service_setid']?>)" name="Delete" value="Delete" class="btn btn-primary"></td>
    </tr>  
