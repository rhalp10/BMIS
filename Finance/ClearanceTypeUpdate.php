...
<body>
    ...
    <br><br>
    <div class="head">
        <font size="5">Clearance Update</font>
    </div>
    <br><br>

    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <button type="button" class="btn btn-primary col-lg-offset-0"
        onclick="location.href = 'ViewClearanceList.php';">Back
    ...
    <section id="asd" class="asds">
        ...
        <article>
			...
			include('dbcon.php');
			$id = $_GET["id"];
			$query =mysqli_query($db, "SELECT * FROM `finance_clearance_list` WHERE `clearance_id` = '$id'");
		...
		?>
                            ...
                            <tr>
                                ...
                                <td><input type="number" class="form-control" readonly value="<?php echo $id; ?>"
                                        required name="clearance_id" size="50"></td>
                                </div>
                            </tr>
