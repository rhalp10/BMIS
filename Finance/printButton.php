...
<tr>
	<td><div class="form-group col-lg-offset-4 col-md-4"></div>
		<div class="form-group col-lg-offset-4 col-md-4">
			<label for="year"></label>
		<td><?php
				include('dbcon.php');
				$query = $con->query("SELECT DISTINCT income_year FROM finance_fundoperation_incomeset ORDER BY income_year DESC");
...
<select name="month">
	<option selected value="" class="form-control" required>Select Month</option>
			...
			<br><br>
	<td><div class="clearfix"><input type="submit" name="submit" value="Print" class="btn btn-success" target="Fradisplay"></td>
</tr>
</div></div>
</form>
</center>
