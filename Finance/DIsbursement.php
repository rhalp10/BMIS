...
<div class="head"><font size="5">Disbursement</font></div>
<br><br>
...
<center>
	...
	<tr>
		...
		<td><div class="form-group col-md-4">
			...
			<td><input type="text" class="form-control" size="50" id="col2" name="col2" placeholder="Enter Disbursement Type" required></td>
		</div>

		<td><div class="form-group col-md-4">
			<label for="col3">Amount</label>
			<td><input type="text" maxlength=20 class="form-control input-sm text-left amount" size="50" id="col3" name="col3" placeholder="Enter Disbursement Amount"required></td>
		</div>
	</tr>
