...
session_start();
	include("dbcon.php");
	$id = $_POST['service_id'];
	$sp = mysqli_real_escape_string($con, $_POST['service_position']);
...
$date = mysqli_query($con, "SELECT service_year, service_setid FROM finance_fundoperation_psset WHERE `service_year` = $d AND `service_setid`='$id'");
