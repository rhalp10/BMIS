...
$res = mysqli_query($con, "SELECT * FROM `finance_disbursement`");
$tp = 0;?>
...
<td><a href="DisbursementUpdate.php?id=<?php echo $row['disbursement_id']?>" class="btn btn-primary">Update</a></td>
    <td><input type="button" onClick="deleteme(<?php echo $row['disbursement_id']?>)" name="Delete" value="Delete" class="btn btn-primary"></td>
    </tr>  
