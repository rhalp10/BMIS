...
<body>
    ...
    <button type="button" class="btn btn-primary col-lg-offset-0"
        onclick="location.href = 'MOOEFundOperationSet.php';">Back
...
$iid = $row["mooe_id"];?>
                    <tr>
                        ...
                        <td><a href="MOOEFundOperationSetUpdate.php?id=<?php echo $row['mooe_setid']?> &year=<?php echo $row['mooe_year']; ?>&iid=<?php echo $row['mooe_id']; ?>"
                                class="btn btn-primary">Update</a></td>
                        <td><input type="button" onClick="deleteme(<?php echo $row['mooe_setid']?>)" name="Delete"
