...
$query = "SELECT * from transactions t inner join students s on t.studentnum = s.studentnum order by c_status,s.s_lname,bdate,c_status";	
...
<br>
<big><b>There are currently '.$num.' transactions in the system.</b></big><br><br>
...
<table align="center" width ="650" cellspacing="2" style="table-layout:fixed" cellpadding="2" border="1">
	...
	$html1='<p>There are currently no registered librarian.</p>'; 
	$html2='';
	$html3='';
