...
<p><big><b>There are currently '.$num.' subjects.</b></big></p>


<table align="center" cellspacing="2" style="table-layout:fixed" cellpadding="2" border="1">
	<tr><td align="center" width = "200"><b>Subject ID</b></td><td width="450" align="center"><b>Subject Name</b></td></tr> ';
	// Fetch and print all the records.
	$html2='';
	while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
		$html2= $html2.'<tr><td align=\"left\">' . stripslashes($row[0]) . '</td><td align=\"left\">'.$row[1].'</td></tr>';
	}
