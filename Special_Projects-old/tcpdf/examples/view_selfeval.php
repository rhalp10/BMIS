...
if ($num<=0)
{
	header ("Location:  http://" . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . "/revert2.php");
	exit();
	}
...
$semyear=$_POST['semyear'];
$empid=$_POST['empid'];
$query = "SELECT a1,a2,a3,a4,a5,b1,b2,b3,b4,b5,c1,c2,c3,c4,c5,d1,d2,d3,d4,d5 from eval_self where empcode='$empid' and semyear = '$semyear' limit 1";	
...
<tr><td colspan="2"><b>Self Evaluation</b></td></tr>
...
$semyear=$_POST['semyear'];
$empid=$_POST['empid'];
$query = "SELECT a1,a2,a3,a4,a5 from eval_self where empcode='$empid' and semyear = '$semyear' limit 1";	
...
$semyear=$_POST['semyear'];
$empid=$_POST['empid'];
$query = "SELECT b1,b2,b3,b4,b5 from eval_self where empcode='$empid' and semyear = '$semyear' limit 1";	
...
$semyear=$_POST['semyear'];
$empid=$_POST['empid'];
$query = "SELECT c1,c2,c3,c4,c5 from eval_self where empcode='$empid' and semyear = '$semyear' limit 1";	
...
$semyear=$_POST['semyear'];
$empid=$_POST['empid'];
$query = "SELECT d1,d2,d3,d4,d5 from eval_self where empcode='$empid' and semyear = '$semyear' limit 1";	
...
//----------------USING A LOG-----------------
				...
				$content =  date('m/d/Y h:i:s a', time()) ." - ". $_COOKIE['userid']. " viewed a record. viewed " . $empid . " - ( ".$name." ) self evaluation of ". $_COOKIE['semyear']."\r\n'eval_self' - 1 row retrieved\r\n";
