...
$query = "SELECT * from studeval where empcode='$empid'";	
...
$html1 = '<p><big><b>There are currently '.$num.$empid.' registered users.</b></big></p>


	<table align="center" cellspacing="2" cellpadding="2" border="1">
	<tr><td align="left"><b>College Code</b></td><td align="left"><b>College Description</b></td><td align="left"><b>Dean</b></td></tr> ';
	// Fetch and print all the records.
	while ($row = mysql_fetch_array($result, MYSQL_NUM)) {
		$html2= $html2.'<tr><td align=\"left\">' . stripslashes($row[0]) . '</td><td align=\"left\">'.$row[1].'</td><td align=\"left\">'.$row[2].'</td></tr>';
	}
...
$html = '<div style="text-align:center">The1 words &#8220;<span dir="rtl">&#1502;&#1494;&#1500; [mazel] &#1496;&#1493;&#1489; [tov]</span>&#8221; mean &#8220;Congratulations!&#8221;</div>';
$pdf->writeHTML($html, true, false, true, false, '');
