...
$muser_id=$user_id;
	...
	If($muser_id ){
        ...
        $query=mysqli_query($connections,"INSERT INTO resident_family(relation_ID,res_ID,family_res_ID,relType_ID) VALUES('$Frid','$db_res_id','$muser_id','3') ");
...
<div class="panel panel-default">
    <div class="panel-heading">  <h4 >Father Background </h4>
   <div class="panel-body">
